...
namespace SampleApp
{
    public partial class MainForm : Form
    {
        ...
        private void openJPEGURLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                "http://192.168.1.64//Streaming/Channels/1"
            };
            ...
            if (form.ShowDialog(this) == DialogResult.OK)
            {
                ...
                jpegSource.Login = "admin";
                jpegSource.Password = "Qwer1234";
        ...
        private void openMJPEGURLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            form.URLs = new string[]
                {
                    "http://192.168.1.64/Streaming/Channels/1/httppreview",
        ...
        private void videoSourcePlayer_NewFrame(object sender, NewFrameEventArgs args)
        {
            lock (this)
            {
                if (detector != null)
                {
                    ...
                    historyValuesLabel.Text = motionLevel.ToString();
